                    ...
                    <table id="table2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="fila<%=e.getId()%>">
                                ...
                                <td class="align-center"><%=e.getIdCliente().getNombres()%></td>
                                <td class="align-center"><%=e.getIdCliente().getApellidos()%></td>
                                <td class="align-center"><%=e.getFecha()%></td>
                                <td class="align-center"><%=e.getServicio()%></td>
                                <td class="align-center"><%=e.getProducto()%></td>
                                <td class="align-center"><%=e.getCantidad()%></td>
